                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="btn-group float-right m-b-20">
                                <a href="{{route('admin/addemp')}}"><button type="button" class="btn btn-custom dropdown-toggle page-title-drop waves-effect waves-light"><span class="m-l-5"><i class="zmdi zmdi-account-add"></i></span> Add Account</button></a>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style=" vertical-align: middle;">
                                                        <center>
                                                            ...
                                                            <a href="{{route('employee-dtr')}}"><span class="m-l-2"><i class="zmdi zmdi-eye action-icons" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View"></i></span></a>

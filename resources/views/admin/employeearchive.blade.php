...
<head>
    ...
    <title>Archived Employee Records</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="page-title">Archived Employees</h4>
                        </div>
                    </div>
            ...
            <footer class="footer">2019 © <span class="d-none d-sm-inline-block">Shoppetown</span>
            </footer>

...
<head>
    ...
    <title>Archived Intern Records</title>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="page-title">Archived Intern</h4>
                        </div>
                    </div>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach($sho as $key)
                                            <tr>
                                                ...
                                                <td>{{$key->intern_lastname}}, {{$key->intern_firstname}} {{$key->intern_middlename}} </td>
                                                <td>{{$key->intern_nickname}}</td>
                                                <td>{{$key->intern_department}}</td>
                                                <td>{{$key->intern_num}}</td>

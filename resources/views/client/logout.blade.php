...
<body class="background3" id="landing-page">
        ...
        <div class="row">
            <div class="card2  col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="left-info col-md-5 col-sm-5 col-xs-5 left-background">
                    <p><h5 class="goodbye-greet">Goodbye {{$validate_emp_num[0]->emp_nickname}}! <br> Keep Safe!</h5><center></p>
                    </div>
                ...
                <div class="left-info col-md-5 col-sm-5 col-xs-5 left-background">
                    <p><h5 class="goodbye-greet">Goodbye {{$validate_intern_number[0]->intern_firstname}}! <br> Keep Safe!</h5><center></p>
                    </div>
                    <div class="right-info col-md-7 col-sm-7 col-xs-7 right-background">
